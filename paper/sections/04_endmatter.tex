...
The reproducibility package is publicly available in the \href{https://github.com/hjy075/history-start-sensitivity}{GitHub repository}. It contains the analysis notebooks, paper source, derived summary tables, and paper figures, but no third-party raw data. The Visuelle notebook intentionally requires a user-supplied dataset path obtained through the official access route; the FreshRetail notebook downloads the official Hugging Face dataset by repository identifier.
